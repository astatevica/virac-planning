...
public interface ICRUDWorkPlanService extends ICRUDBase<WorkPlan>{
	...
	//C - create 
	public abstract void create(int idStudentWork,int idPlan,String workDone) throws Exception;
			
	//U - update
	public abstract void updateById(int id, int idStudentWork,int idPlan,String workDone) throws Exception;
		
	//Filter by Student Work
	public abstract ArrayList<WorkPlan> selectAllWorkPlanByStudentWork(int idStudentWork) throws Exception;
